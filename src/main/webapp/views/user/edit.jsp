		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-8 col-xs-12">
					<div class="white-box">
						<form class="form-horizontal form-material" action="<%= contextPath %>/user/edit?id=${user_edit.getId()}" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
									...
									<c:forEach var="role" items="${list_role}">
										<option ${user_edit.getRoleName() == role.getRoleName() ? "selected" : ""} value="${role.getId()}">${role.getRoleName()}</option>
									</c:forEach>
									</select>
								</div>
							</div>
