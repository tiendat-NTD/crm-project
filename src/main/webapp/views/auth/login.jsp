...
<link rel="stylesheet"
	href="<%=contextPath%>/views/layout/assets/css/login.css">
<style>
body
{
				...
				<div class="col-lg-4 d-block mx-auto mt-5">
					<div class="row">
						<div class="col-xl-12 col-md-12 col-md-12">
							<div class="card">
								<form action="<%=contextPath + Constants.URL_LOGIN%>" method="post">
									<div class="card-body wow-bg" id="formBg">
										...
										<div class="input-group mb-3">
											<input type="text" name="email" class="form-control textbox-dg"
												placeholder="Email" style="color: #0defa0;">
										</div>
										<div class="input-group mb-4">
											<input type="password" name="password" class="form-control textbox-dg"
												placeholder="Mật khẩu" style="color: #0defa0;">
										</div>
		...
		<div class="row mt-5">
			<div class="col-md-5 m-auto mt-5">
				...
				<div class="p-4 border mt-4">
					<form action="<%=contextPath + Constants.URL_LOGIN%>"
						method="post">
