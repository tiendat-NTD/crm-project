				...
				<div class="col-md-8 col-xs-12">
					<div class="white-box">
						<form id="formAdd" class="form-horizontal form-material"
							action="<%=contextPath%>/task/edit?id=${task_edit.getId()}" method="post">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input style="pointer-events: none;" required type="text" name="task_name"
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<select style="pointer-events: none;" id="ds_user" required
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input style="pointer-events: none;" required type="date" placeholder="dd/MM/yyyy"
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<select style="pointer-events: none;" required
							...
							<div class="form-group">
								<div class="col-sm-12">
									<a href="<%=contextPath%>/project/details?id=${task_edit.getIdProject()}" class="btn btn-primary">Quay
										lại</a>
								</div>
							</div>
						</form>
